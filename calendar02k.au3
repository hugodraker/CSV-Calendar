...
Func _PrintSchedule()
    ...
    Local $iPageWidth  = _WinAPI_GetDeviceCaps($hPrintDC, 8) 
    Local $iPageHeight = _WinAPI_GetDeviceCaps($hPrintDC, 10) 
    Local $iDPIY       = _WinAPI_GetDeviceCaps($hPrintDC, 90) 
    ...
    If UBound($aPrintIdx) == 0 Then
        ...
        Local $tNoRect = _WinAPI_CreateRect($iMargin, $iY, $iPageWidth - $iMargin, $iY + $iLineHeight)
    ...
    Else
        ...
        For $i = 0 To UBound($aPrintIdx) - 1
            ...
            Local $tTitleRect = _WinAPI_CreateRect($iMargin, $iY, $iPageWidth - $iMargin, $iY + $iLineHeight)
            _WinAPI_DrawText($hPrintDC, $aEvents[$e][0], $tTitleRect, BitOR($DT_LEFT, $DT_TOP, $DT_SINGLELINE, $DT_END_ELLIPSIS))
            $iY += $iLineHeight
            
            _WinAPI_SelectObject($hPrintDC, $hFont)
            Local $tDescRect = _WinAPI_CreateRect($iMargin, $iY, $iPageWidth - $iMargin, $iY + $iLineHeight)
